    ...
    return (
      <div className="carrito-page">
        <div className="checkout-success">
          ...
          <p>
            Gracias <strong>{usuario.nombre}</strong>, tus cursos ya están disponibles
            en tu cuenta.
          </p>
      ...
      <div className="carrito-header">
        ...
        <p>
          {carrito.length === 0
            ...
            : carrito.length + " curso" + (carrito.length > 1 ? "s" : "") + " agregado" + (carrito.length > 1 ? "s" : "")}
        </p>
      </div>
              ...
              <div className="carrito-item" key={index}>
                ...
                <div className="ci-thumb">
                  {curso.imagen ? (
                    ...
                    <div className="ci-thumb-placeholder">📖</div>
                  )}
                </div>
                ...
                <div className="ci-data">
                  ...
                  <div className="ci-tags">
                    {curso.categoria && (
                      <span className="ci-tag">{curso.categoria}</span>
                    )}
                    {curso.nivel && (
                      <span className="ci-tag">{curso.nivel}</span>
                    )}
                    {curso.duracion && (
                      <span className="ci-tag">⏱ {curso.duracion}</span>
                    )}
                  </div>
                  {curso.rating && (
                    <span className="ci-rating">⭐ {curso.rating}</span>
                  )}
                </div>

                <div className="ci-acciones">
                  <span className="ci-precio">S/ {curso.precio}</span>
                  <button
                    className="ci-quitar"
            ...
            <div className="cupon-area">
              ...
              {msgCupon && (
                <p className={
                  ...
                  {msgCupon.startsWith("ok") ? "✅" : "⚠️"} {msgCupon.split(":")[1]}
                </p>
              )}
